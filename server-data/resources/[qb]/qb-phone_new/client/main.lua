...
AddEventHandler('qb-phone_new:client:AddNewSuggestion', function(SuggestionData)
    ...
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Telemóvel",
                text = "Yeni Bir Önerilen Kişiniz Var",
                icon = "fa fa-phone-alt",
                color = "#04b543",
                timeout = 1500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Telemóvel",
                content = "Yeni Bir Önerilen Kişiniz Var",
                icon = "fa fa-phone-alt",
                timeout = 3500,
                color = "#04b543",
            },
...
AddEventHandler('qb-phone_new:client:RemoveBankMoney', function(amount)
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Banka",
                text = "Borçlandırıldın €"..amount..",- Hesabınız",
                icon = "fas fa-university",
                color = "#ff002f",
                timeout = 3500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Banka",
                content = "Borçlandırıldın €"..amount..",- Hesabınız",
                icon = "fas fa-university",
                timeout = 3500,
                color = "#ff002f",
            },
...
RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-lapraces:server:GetRacingData', function(RaceData)
        ...
        if dist <= 115.0 then
            ...
            QBCore.Functions.Notify('Yarıştan Çok Uzaklaştın. Konum GPS e işaratlenecek', 'error', 5000)
